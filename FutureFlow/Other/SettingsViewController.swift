...
class SettingsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        showPointsOfInterest.isOn = true
        showMapSwitch.isOn = false
        showMapSwitch.isHidden = true
        one.isHidden = true
        two.isHidden = true
        three.isHidden = true
        showPointsOfInterest.isHidden = true
        showRouteDirections.isHidden = true
        searchResultTable.isHidden = true
        ButtonClick.isHidden = false
        ButtonClick.layer.cornerRadius = 20
